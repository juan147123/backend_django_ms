...
class RiesgosOportunidades(models.Model):
    id_encabezado = models.ForeignKey(RiesgosOportunidadesEncabezado, models.DO_NOTHING,
                                      db_column='id_encabezado', blank=True, null=True, related_name='riesgosoportunidades')
